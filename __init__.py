...
#define DYNAMIXEL_SERIAL_PORT {scn.scn_prop.DynamixelSerialPort}
#define DYNAMIXEL_DIR_PIN {scn.scn_prop.DynamixelDirPin}
#define DYNAMIXEL_SPEED {scn.scn_prop.DynamixelSpeed}
#define DYNAMIXEL_BAUD {scn.scn_prop.DynamixelBaud}
#define DYNAMIXEL_PROTOCOL_VER {scn.scn_prop.DynamixelProtocolVer}
